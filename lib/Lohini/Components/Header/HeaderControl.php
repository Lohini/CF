...
use Lohini\Extension\Assets\FormulaeManager,
	Nette\Utils\Html;
...
implements \Nette\ComponentModel\IComponent
{
	/** @var string */
	public $defaultTitle;
	/** @var bool */
	...
	/** @var \Lohini\Application\UI\Presenter */
	private $parent;
	/** @var array */
	 ...
	 * @param FormulaeManager $formulaeManager
	 * @param \Nette\Http\Request $httpRequest
	 */
	public function __construct(\Nette\Application\Application $application, FormulaeManager $formulaeManager, \Nette\Http\Request $httpRequest)
	{
	...
	public function addMeta(array $meta)
	{
		if (!isset($meta['name']) && !isset($meta['http-equiv'])) {
			throw new \Nette\InvalidArgumentException('Meta must contain either "name" or "http-equiv".');
			}
